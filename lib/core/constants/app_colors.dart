...
class AppColors {
  ...
  static const Color alertHighAccent = Color(0xFFEF5350);
  static const Color alertMediumBackground = Color(0xFFFFF8E1);
  static const Color alertMediumAccent = Color(0xFFFFA000);
  static const Color alertLowBackground = Color(0xFFE1F5FE);
